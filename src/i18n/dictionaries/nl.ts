...
const nl: Dictionary = {
  ...
  footer: {
    companyDescription:
      "Lumni bouwt systemen, automatiseert processen en bedt ingenieurs in je team in. Van de eerste diagnose tot code in productie.",
    ...
    servicesHref: "https://lumni.dev.br/nl#servicos",
    privacy: "Privacy",
    terms: "Voorwaarden",
    backToTop: "Terug naar boven",
    rights: "Alle rechten voorbehouden.",
    ariaLegalNav: "Juridische pagina’s",
    privacyHref: "https://lumni.dev.br/nl/privacy",
    termsHref: "https://lumni.dev.br/nl/terms",
  },
};
